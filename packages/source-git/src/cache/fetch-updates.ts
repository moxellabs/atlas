...
/**
 * Resolves the existing working tree HEAD without fetching or checking out a remote ref.
 */
export async function resolveCurrentCheckoutRevision(
	options: FetchUpdatesOptions,
): Promise<string> {
	return resolveCurrentRevision(options);
}
